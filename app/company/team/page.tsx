        ...
        <section className="py-16 sm:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-neutral-900 to-black rounded-2xl shadow-2xl p-8 sm:p-12 border-t-4 border-white/20 relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="prose prose-lg max-w-none text-neutral-300 leading-relaxed space-y-4 prose-headings:text-white prose-strong:text-white">
                    <p>
                    ...
                    <p>
                      ...
                      a singular, unwavering principle: <strong className="text-white">business is about people, not just products</strong>.
                    </p>
                    ...
                    <p>
                      However, our extensive inventory is not our greatest asset—<strong className="text-white">our reputation is</strong>.
                    </p>
                  ...
                  <div className="mt-8 pt-8 border-t border-white/10">
                    <div className="flex items-center gap-4">
                      <div className="relative w-20 h-20 rounded-full overflow-hidden flex-shrink-0 border-4 border-white/20">
                        <Image
                      ...
                      <div>
                        <div className="font-bold text-xl text-white">Maksim Harbatsevich</div>
                        <div className="text-neutral-400">Chief Executive Officer</div>
                        <a
                          href="https://www.linkedin.com/in/maksim-h/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 text-white hover:text-neutral-300 transition-colors mt-1"
                        >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {teamMembers.map((member, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-br from-neutral-900 to-black rounded-xl shadow-lg hover:shadow-2xl hover:shadow-white/10 transition-all p-8 border border-white/10"
                  >
                    <div className="flex flex-col sm:flex-row gap-6">
                      <div className="relative w-32 h-32 rounded-xl overflow-hidden flex-shrink-0 mx-auto sm:mx-0 border-4 border-white/20">
                        <Image
                          src={member.image}
                          alt={member.name}
                          fill
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        ...
                        <p className="text-neutral-300 leading-relaxed mb-4">{member.bio}</p>
                        <div className="flex flex-col sm:flex-row gap-3 justify-center sm:justify-start">
                          ...
                          <a
                            ...
                            className="inline-flex items-center justify-center gap-2 px-4 py-2 border-2 border-white/20 text-white rounded-lg hover:border-white/40 hover:bg-white/10 transition-colors text-sm font-medium"
                          >
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/products"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white text-black font-semibold rounded-lg hover:bg-neutral-100 hover:shadow-xl transition-all transform hover:scale-105"
                >
                  View Our Products
                </Link>
                <Link
