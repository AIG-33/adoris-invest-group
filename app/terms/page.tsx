      ...
      <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black py-12">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Main Content */}
            <div className="bg-gradient-to-br from-neutral-900 to-black rounded-lg shadow-sm border border-white/10 p-8 space-y-8">
              {/* Original Products */}
              <section>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gradient-to-br from-neutral-800/50 to-neutral-900/50 border border-white/10 rounded-lg p-4">
                        <div className="text-3xl font-bold text-white mb-2">5%</div>
                        <p className="text-sm font-semibold text-neutral-300">Orders €50,000+</p>
                      </div>
                      <div className="bg-gradient-to-br from-neutral-800/50 to-neutral-900/50 border border-white/10 rounded-lg p-4">
                        <div className="text-3xl font-bold text-white mb-2">10%</div>
                        <p className="text-sm font-semibold text-neutral-300">Orders €100,000+</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Contact CTA */}
            <div className="mt-12 bg-gradient-to-br from-neutral-900 to-black border border-white/10 rounded-lg p-8 text-white text-center">
